...
# Category set — includes the 3 later categories missing from old builder
CATEGORIES = [
    ...
    ("christian-liberty", "Christian Liberty", "Freedom to profess Christ — including freedom to disagree.", "god_first", 4),
    ...
    ("public-justice", "Public Justice & Law/Order", "The magistrate bears the sword to punish evil and protect the innocent.", "god_first", 11),
    ("refuse-federal-overreach", "Refuse Federal Overreach", "10th-Amendment sovereignty — nullify unconstitutional federal mandates.", "state_first", 12),
    ("refuse-state-overreach", "Refuse State Overreach", "Subsidiarity — local control against unconstitutional state mandates.", "local_first", 13),
]

# Hub / tool / civic pages — Sheriff owns civic/local framing; Rush can refine kickers later
HUB_CARDS = [
    # out_name, kicker, title, subtitle, badge, accent_key
    ("og-citizen.jpg", "RESOLUTE Citizen", "Christian voter scorecard.", "10 categories · 100 points · officials across all 50 states.", "100-PT", "silver"),
    ("og-citizen-hub.jpg", "RESOLUTE Citizen", "Vote with a clear scorecard.", "Biblical categories, cited records, tap-to-call contact.", "HUB", "silver"),
    ("og-citizen-how-to-use.jpg", "Quick start", "How to use RESOLUTE Citizen + Local.", "Look up candidates, find your reps, watch council, weigh in.", "GUIDE", "silver"),
    ("og-citizen-scoring-system.jpg", "Methodology", "How the 100-point scorecard works.", "God First 60 + America First 40 — transparent rubric, cited sources.", "RUBRIC", "gold"),
    ("og-citizen-find-my-reps.jpg", "Find your reps", "Who represents your household?", "Look up local, state, and federal officials — then score them.", "LOOKUP", "silver"),
    ("og-citizen-rankings.jpg", "Rankings", "Who scores highest — and lowest.", "Compare officials by category, office, and state.", "LIST", "gold"),
    ("og-citizen-formers.jpg", "Formers", "Officials no longer in office.", "Historical scorecard records kept for accountability.", "ARCHIVE", "silver"),
    ("og-citizen-issues.jpg", "Ballot measures", "What new laws are on the ballot.", "Statewide measures and amendments — plain English + sources.", "2026", "gold"),
    ("og-citizen-table.jpg", "Full table", "The complete official score table.", "Sortable rows across offices — scores, photos, contact.", "DATA", "silver"),
    ("og-citizen-compare.jpg", "Compare", "Side-by-side candidate comparison.", "Stack records on the same biblical scorecard.", "VS", "silver"),
    ("og-citizen-map.jpg", "Map", "Coverage map of scored officials.", "See where RESOLUTE Citizen has eyes on the roster.", "MAP", "silver"),
    ("og-citizen-state.jpg", "By state", "State-level scorecard entry.", "Drill into governors, AGs, legislators, and statewide races.", "STATE", "gold"),
    ("og-citizen-races.jpg", "2026 races", "Key races on the scorecard.", "Senate, House, and governor matchups with RESOLUTE framing.", "2026", "gold"),
    ("og-citizen-methodology-foreign-influence.jpg", "Methodology", "Foreign influence scoring notes.", "How lobby money and foreign pressure enter the rubric.", "NOTE", "gold"),
    ("og-citizen-petition.jpg", "Petition", "Send a clear message upstream.", "Draft and deliver with primary-source civic framing.", "ACTION", "silver"),
    # Civic / local lane (Sheriff primary)
    ("og-citizen-fredericksburg.jpg", "Fredericksburg, VA", "Know your council. Watch the meeting.", "Ward-level engagement — agendas, comment rules, local scores.", "WARD 4", "local"),
    ("og-citizen-council-notes.jpg", "Council notes", "Local meeting intel, cited.", "What moved in council — and what still needs a citizen voice.", "LOCAL", "local"),
]
