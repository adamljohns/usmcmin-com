 ...
 * and write them to `tmc-father/drills/<moduleId>.json`.
 *
 *   node tmc-father/extract-drills.js
 *
 * The exports live at assets/media/tmc-father/<moduleId>/{flashcards,quiz}/*.html.
 ...
 * Re-run this after dropping new exports in, then `node tmc-father/generate.js`.
 */
...
const MEDIA_ROOT = path.resolve(__dirname, '..', 'assets', 'media', 'tmc-father');
