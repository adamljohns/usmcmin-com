...
function siteNav() {
  return `<nav>
    ...
    <ul class="nav-links">
      ...
      <li><a href="/tmc-father/index.html" class="active">The Father Course</a></li>
...
function courseRail(page) {
  ...
  return `<div class="course-rail">
    <div class="course-rail-inner">
      <a class="course-rail-name" href="index.html">The Father Course</a>
...
<head>
  ...
  <link rel="stylesheet" href="/assets/css/tmc-father.v2.css">
  <link rel="icon" type="image/svg+xml" href="/assets/icons/favicon.svg">
  <link rel="icon" type="image/png" sizes="32x32" href="/assets/icons/favicon-32.png">
  <script src="/assets/js/main.js" defer></script>
  <script src="/assets/js/tmc-father.v1.js" defer></script>
  <link rel="manifest" href="tmc-father.webmanifest">
...
<body class="tmc" data-course-page="${esc(page)}" style="${accentStyle(page)}">
  ...
  ${body}
  ${siteFooter()}
  <script>if('serviceWorker' in navigator){window.addEventListener('load',function(){navigator.serviceWorker.register('sw.js',{scope:'/tmc-father/'}).catch(function(){});});}</script>
</body>
</html>
`;
}
...
// Built by tmc-father/print/*.py — see that folder's README.
function printPack() {
  const inserts = course.modules.map((module) => `<li><a href="/downloads/tmc-father/The_Husband_Course_Module_${String(module.number).padStart(2, '0')}_INSERT.pdf">Module ${module.number} insert &mdash; ${esc(module.title)}</a></li>`).join('\n');
  return `<section class="print-pack" aria-labelledby="print-title">
      ...
      <div class="print-lead">
        <div>
          <h3><a href="/downloads/tmc-father/The_Husband_Course_FIELD_WORKBOOK.pdf">The Husband&rsquo;s Field Workbook</a></h3>
...
function renderAbout() {
  return layout({
    ...
    description: 'How The Father Course was made, what it includes, and what it is not.',
    page: 'about',
    noindex: true,
    body: `<main id="main-content">
      ...
      <article>
        ...
        <section aria-labelledby="method-title"><h2 id="method-title">How it was made</h2>
          ...
          <p>The site is generated from source files in this repository (<code>tmc-father/course.v1.js</code> and <code>module-*.field-manual.js</code>) via <code>node tmc-father/generate.js</code>. Progress is stored only in <code>localStorage</code> on your device — no account, no sync.</p>
        </section>
  ...
  return layout({
    ...
    body: `<main id="main-content" class="lesson">
      ...
      <header class="lesson-header">
        <span class="course-badge">Module ${module.number} &middot; The Father Course</span>
...
function renderProgress(checkTotals = {}) {
  ...
  return layout({
    ...
    description: 'Review and reset local progress for The Father Course.',
    page: 'progress',
    body: `<main id="main-content">
...
function renderAll(root = path.resolve(__dirname, '..')) {
  const output = path.join(root, 'tmc-father');
