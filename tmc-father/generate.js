...
function printPack() {
  return `<section class="print-pack" aria-labelledby="print-title">
      ...
      <p class="section-intro">The Father Course field workbook and module inserts are not published yet. This draft keeps the web modules clickable. Husband Course print sheets live on the Husband Course page &mdash; they are not this course.</p>
      <p class="print-meta">Print pack: not shipped</p>
    </section>`;
}
