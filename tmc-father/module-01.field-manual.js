...
const fieldManual = {
  ...
  assessment: {
    ...
    quizHref: '../assets/media/tmc-father/m01/quiz/marriage-quiz.html',
    quizTitle: 'Module 1 Marriage Quiz'
  },
  artifacts: [
    { slug: 'video-the-marriage-course', state: 'local', group: 'video', kind: 'Video', title: 'The Marriage Course', summary: 'Video overview of foundation themes.', href: '../assets/media/tmc-father/m01/video/the-marriage-course.mp4', mediaType: 'video' },
    { slug: 'video-blueprint-stress-test', state: 'local', group: 'video', kind: 'Video', title: 'The Blueprint and the Stress Test', summary: 'Foundation habits under pressure.', href: '../assets/media/tmc-father/m01/video/the-blueprint-and-stress-test.mp4', mediaType: 'video' },
    { slug: 'audio-blind-spots-vineyard', state: 'local', group: 'audio', kind: 'Audio', title: 'Blind spots in the vineyard marriage course', summary: 'Where vineyard metaphors and habits misfire.', href: '../assets/media/tmc-father/m01/audio/blind-spots-in-the-vineyard.mp3', mediaType: 'audio' },
    { slug: 'audio-why-course-fails', state: 'local', group: 'audio', kind: 'Audio', title: 'Why The Marriage Course fails some couples', summary: 'Limits and safety inversions.', href: '../assets/media/tmc-father/m01/audio/why-the-marriage-course-fails-some-couples.mp3', mediaType: 'audio' },
    { slug: 'slides-marital-maintenance', state: 'local', group: 'slides', kind: 'PDF', title: 'Marital Maintenance Playbook', summary: 'Maintenance habits and seasons.', href: '../assets/media/tmc-father/m01/slides/marital-maintenance-playbook.pdf', linkLabel: 'Open slide deck' },
    { slug: 'slides-tending-vineyard', state: 'local', group: 'slides', kind: 'PDF', title: 'Tending the Marital Vineyard', summary: 'The four vineyard tasks.', href: '../assets/media/tmc-father/m01/slides/tending-the-marital-vineyard.pdf', linkLabel: 'Open slide deck' },
    { slug: 'infographic-connection-roadmap', state: 'local', group: 'infographics', title: 'Marriage Connection Roadmap', summary: 'Visual roadmap of connection habits.', href: '../assets/media/tmc-father/m01/infographics/marriage-connection-roadmap.png', alt: 'Field graphic titled The Connection Roadmap: Tending Your Marriage Vineyard. Seven panels cover the drift into emotional disconnection, the vineyard framework of adjusting, pruning, supporting and renewing, safety carve-outs marking which relationships this course suits, the protected weekly date, proactive nurturing over fault-finding, warning signs calling for professional help, and a seven-day action plan running from scheduling the date to reviewing what helped.' },
    { slug: 'infographic-vineyard-field-guide', state: 'local', group: 'infographics', title: 'Marriage Vineyard Field Guide', summary: 'Single-page field guide on adjusting, pruning, supporting, and renewing.', href: '../assets/media/tmc-father/m01/infographics/marriage-vineyard-field-guide.png', alt: 'Infographic titled Marriage Vineyard Field Guide illustrating four vineyard tasks for marital maintenance.' },
    { slug: 'report-building-foundations', state: 'local', group: 'reports', title: 'Building Strong Foundations', summary: 'Executive briefing on foundation habits.', href: '../assets/media/tmc-father/m01/reports/episode-1-building-strong-foundations.pdf', linkLabel: 'Read the report' },
    { slug: 'report-we-to-me', state: 'local', group: 'reports', title: 'From We to Me: Navigating the Seasons of Connection', summary: 'Seasons-of-life framing.', href: '../assets/media/tmc-father/m01/reports/from-we-to-me-seasons-of-connection.pdf', linkLabel: 'Read the report' },
    { slug: 'report-vineyard-secret', state: 'local', group: 'reports', title: 'The Vineyard Secret: Five Surprising Lessons', summary: 'Popular-article register — use as prompt, not proof.', href: '../assets/media/tmc-father/m01/reports/vineyard-secret-five-lessons.pdf', linkLabel: 'Read the report' },
    ...
    { slug: 'quiz-marriage-quiz', state: 'local', group: 'quiz', title: 'Marriage Quiz', summary: 'Knowledge check over Module 1 material.', href: '../assets/media/tmc-father/m01/quiz/marriage-quiz.html', linkLabel: 'Open the quiz' }
  ]
};
