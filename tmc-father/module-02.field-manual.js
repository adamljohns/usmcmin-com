...
const fieldManual = {
  ...
  assessment: {
    ...
    quizHref: '../assets/media/tmc-father/m02/quiz/communication-quiz.html',
    quizTitle: 'Module 2 Communication Quiz',
    flashcardsHref: '../assets/media/tmc-father/m02/flashcards/marriage-flashcards.html',
    flashcardsTitle: 'Module 2 Marriage Flashcards'
  },
  artifacts: [
    { slug: 'video-effective-communication', state: 'local', group: 'video', kind: 'Video', title: 'Effective Communication', summary: 'Video overview of communication themes.', href: '../assets/media/tmc-father/m02/video/effective-communication.mp4', mediaType: 'video' },
    { slug: 'video-five-listening-habits', state: 'local', group: 'video', kind: 'Video', title: '5 Listening Habits That Ruin Communication', summary: 'The five bad habits and how to interrupt them.', href: '../assets/media/tmc-father/m02/video/five-listening-habits.mp4', mediaType: 'video' },
    { slug: 'audio-vulnerability-safety', state: 'local', group: 'audio', kind: 'Audio', title: 'Why vulnerability needs a safety check', summary: 'When disclosure exercises misfire.', href: '../assets/media/tmc-father/m02/audio/vulnerability-safety-check.mp3', mediaType: 'audio' },
    { slug: 'audio-three-levels', state: 'local', group: 'audio', kind: 'Audio', title: 'The Three Levels of Deep Communication', summary: 'Facts, ideas, and feelings.', href: '../assets/media/tmc-father/m02/audio/three-levels-of-communication.mp3', mediaType: 'audio' },
    { slug: 'slides-signal-noise', state: 'local', group: 'slides', kind: 'PDF', title: 'Signal and Noise', summary: 'Filtering signal from noise in marital talk.', href: '../assets/media/tmc-father/m02/slides/signal-and-noise.pdf', linkLabel: 'Open slide deck' },
    { slug: 'slides-relational-architecture', state: 'local', group: 'slides', kind: 'PDF', title: 'Relational Architecture', summary: 'Communication structure and habits.', href: '../assets/media/tmc-father/m02/slides/relational-architecture.pdf', linkLabel: 'Open slide deck' },
    { slug: 'infographic-art-of-communication', state: 'local', group: 'infographics', title: 'The Art of Effective Communication', summary: 'Visual summary of levels, habits, and listening.', href: '../assets/media/tmc-father/m02/infographics/art-of-effective-communication.png', alt: 'Infographic titled The Art of Effective Communication showing three communication levels and listening habits.' },
    { slug: 'infographic-mastering-communication', state: 'local', group: 'infographics', title: 'Mastering Marriage Communication Guide', summary: 'Field guide for daily connection practices.', href: '../assets/media/tmc-father/m02/infographics/mastering-marriage-communication.png', alt: 'Infographic titled Mastering Marriage Communication Guide with panels on listening and emotional disclosure.' },
    { slug: 'report-beyond-small-talk', state: 'local', group: 'reports', title: 'Beyond Small Talk', summary: 'Moving past logistics.', href: '../assets/media/tmc-father/m02/reports/beyond-small-talk.pdf', linkLabel: 'Read the report' },
    { slug: 'report-lonelier', state: 'local', group: 'reports', title: 'Why You\'re Lonelier Than You Should Be', summary: 'Counter-intuitive truths about connection.', href: '../assets/media/tmc-father/m02/reports/lonelier-than-you-should-be.pdf', linkLabel: 'Read the report' },
    { slug: 'report-effective-connection', state: 'local', group: 'reports', title: 'Effective Communication and Connection', summary: 'Executive briefing on communication.', href: '../assets/media/tmc-father/m02/reports/effective-communication-and-connection.pdf', linkLabel: 'Read the report' },
    { slug: 'quiz-communication', state: 'local', group: 'quiz', title: 'Communication Quiz', summary: 'Knowledge check.', href: '../assets/media/tmc-father/m02/quiz/communication-quiz.html', linkLabel: 'Open the quiz' },
    { slug: 'flashcards-marriage', state: 'local', group: 'flashcards', title: 'Marriage Flashcards', summary: 'Flashcard drill.', href: '../assets/media/tmc-father/m02/flashcards/marriage-flashcards.html', linkLabel: 'Open the flashcards' }
  ]
};
