...
const fieldManual = {
  ...
  assessment: {
    ...
    quizHref: '../assets/media/tmc-father/m03/quiz/marriage-quiz.html',
    quizTitle: 'Module 3 Marriage Quiz',
    flashcardsHref: '../assets/media/tmc-father/m03/flashcards/marriage-flashcards.html',
    flashcardsTitle: 'Module 3 Marriage Flashcards'
  },
  artifacts: [
    { slug: "video-resolving-conflict", state: "local", group: "video", kind: "Video", title: "Resolving Conflict", summary: "Session video on working a disagreement without making the marriage the battlefield.", href: "../assets/media/tmc-father/m03/video/resolving-conflict.mp4", mediaType: "video" },
    { slug: "video-navigating-conflict", state: "local", group: "video", kind: "Video", title: "Navigating Conflict", summary: "How couples move from position-trading to shared problem-solving.", href: "../assets/media/tmc-father/m03/video/navigating-conflict.mp4", mediaType: "video" },
    { slug: "video-how-to-externalize-marriage-conflict", state: "local", group: "video", kind: "Video", title: "How to Externalise a Conflict", summary: "Putting the problem on the table instead of across from you.", href: "../assets/media/tmc-father/m03/video/how-to-externalize-marriage-conflict.mp4", mediaType: "video" },
    { slug: "audio-why-your-partner-is-not-the-problem", state: "local", group: "audio", kind: "Audio", title: "Why Your Partner Is Not the Problem", summary: "Deep-dive audio on separating the person from the problem.", href: "../assets/media/tmc-father/m03/audio/why-your-partner-is-not-the-problem.mp3", mediaType: "audio" },
    { slug: "audio-when-good-marriage-advice-goes-wrong", state: "local", group: "audio", kind: "Audio", title: "When Good Marriage Advice Goes Wrong", summary: "Critical audio on where conflict advice misfires. Read against the module caution.", href: "../assets/media/tmc-father/m03/audio/when-good-marriage-advice-goes-wrong.mp3", mediaType: "audio" },
    { slug: "audio-when-marriage-tools-become-dangerous-weapons", state: "local", group: "audio", kind: "Audio", title: "When Marriage Tools Become Dangerous Weapons", summary: "Safety inversion: how a fair-fighting rule becomes a control tactic.", href: "../assets/media/tmc-father/m03/audio/when-marriage-tools-become-dangerous-weapons.mp3", mediaType: "audio" },
    { slug: "slides-the-marriage-blueprint", state: "local", group: "slides", kind: "PDF", title: "The Marriage Blueprint", summary: "Session overview deck.", href: "../assets/media/tmc-father/m03/slides/the-marriage-blueprint.pdf", linkLabel: "Open slide deck" },
    { slug: "slides-marital-conflict-blueprint", state: "local", group: "slides", kind: "PDF", title: "Marital Conflict Blueprint", summary: "Four principles through five steps.", href: "../assets/media/tmc-father/m03/slides/marital-conflict-blueprint.pdf", linkLabel: "Open slide deck" },
    { slug: "slides-engineering-us", state: "local", group: "slides", kind: "PDF", title: "Engineering Us", summary: "Systems view of marriage maintenance.", href: "../assets/media/tmc-father/m03/slides/engineering-us.pdf", linkLabel: "Open slide deck" },
    { slug: "infographic-marriage-conflict-resolution-field-guide", state: "local", group: "infographics", title: "Marriage Conflict Resolution Field Guide", summary: "Navigating the Waves Together — includes a red-flag panel.", href: "../assets/media/tmc-father/m03/infographics/marriage-conflict-resolution-field-guide.png", alt: "Illustrated field guide titled Navigating the Waves Together with panels on teamwork, appreciation, and the five-step protocol." },
    { slug: "infographic-marriage-conflict-and-teamwork-guide", state: "local", group: "infographics", title: "Marriage Conflict and Teamwork Guide", summary: "Navigating the Storm — includes a safety overlay.", href: "../assets/media/tmc-father/m03/infographics/marriage-conflict-and-teamwork-guide.png", alt: "Illustrated guide titled Navigating the Storm with a conflict toolkit and a seven-day action plan." },
    { slug: "infographic-marriage-teamwork-guide", state: "local", group: "infographics", title: "Marriage Teamwork Guide", summary: "Five cards on appreciation, differences, timing, and support.", href: "../assets/media/tmc-father/m03/infographics/marriage-teamwork-guide.png", alt: "Illustrated guide titled From Conflict to Connection showing five teamwork cards." },
    { slug: "report-conflict-resolution-and-partnership-briefing", state: "local", group: "reports", title: "Conflict Resolution and Partnership", summary: "Executive briefing — best starting point.", href: "../assets/media/tmc-father/m03/reports/conflict-resolution-and-partnership-briefing.pdf", linkLabel: "Read the report" },
    { slug: "report-from-clashing-oars-to-gliding-boats", state: "local", group: "reports", title: "From Clashing Oars to Gliding Boats", summary: "Systems-flavoured treatment of the rowing metaphor.", href: "../assets/media/tmc-father/m03/reports/from-clashing-oars-to-gliding-boats.pdf", linkLabel: "Read the report" },
    { slug: "report-why-your-biggest-disagreements-secret-weapon", state: "local", group: "reports", title: "Why Your Biggest Disagreements Might Be Your Secret Weapon", summary: "Popular-article register — the headline overclaims; read against the caution.", href: "../assets/media/tmc-father/m03/reports/why-your-biggest-disagreements-secret-weapon.pdf", linkLabel: "Read the report" },
    { slug: "quiz-marriage-quiz", state: "local", group: "quiz", title: "Marriage Quiz", summary: "Knowledge check over this module.", href: "../assets/media/tmc-father/m03/quiz/marriage-quiz.html", linkLabel: "Open the quiz" },
    { slug: "flashcards-marriage-flashcards", state: "local", group: "flashcards", title: "Marriage Flashcards", summary: "Flashcard drill over this module.", href: "../assets/media/tmc-father/m03/flashcards/marriage-flashcards.html", linkLabel: "Open the flashcards" }
  ]
};
