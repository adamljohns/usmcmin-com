...
const fieldManual = {
  ...
  artifacts: [
    { slug: "video-keeping-the-spark-alive", state: "local", group: "video", kind: "Video", title: "Keeping the Spark Alive", summary: "Session video on friendship, attention, and desire over years.", href: "../assets/media/tmc-father/m06/video/keeping-the-spark-alive.mp4", mediaType: "video" },
    { slug: "video-the-engine-of-intimacy", state: "local", group: "video", kind: "Video", title: "The Engine of Intimacy", summary: "Why emotional connection and physical intimacy feed each other.", href: "../assets/media/tmc-father/m06/video/the-engine-of-intimacy.mp4", mediaType: "video" },
    { slug: "video-restoring-the-spark", state: "local", group: "video", kind: "Video", title: "Restoring the Spark", summary: "What to do when the connection has gone quiet.", href: "../assets/media/tmc-father/m06/video/restoring-the-spark.mp4", mediaType: "video" },
    { slug: "video-the-7-day-intimacy-reset", state: "local", group: "video", kind: "Video", title: "The Seven-Day Intimacy Reset", summary: "A week of small, non-pressuring moves.", href: "../assets/media/tmc-father/m06/video/the-7-day-intimacy-reset.mp4", mediaType: "video" },
    { slug: "audio-the-best-sex-starts-at-breakfast", state: "local", group: "audio", kind: "Audio", title: "It Starts Long Before the Bedroom", summary: "Deep-dive audio on intimacy as the whole day, not the last hour of it.", href: "../assets/media/tmc-father/m06/audio/the-best-sex-starts-at-breakfast.mp3", mediaType: "audio" },
    { slug: "audio-why-responsive-desire-fuels-the-marital-spark", state: "local", group: "audio", kind: "Audio", title: "Responsive Desire", summary: "Deep-dive audio on desire that answers rather than initiates.", href: "../assets/media/tmc-father/m06/audio/why-responsive-desire-fuels-the-marital-spark.mp3", mediaType: "audio" },
    { slug: "audio-modernizing-the-psychology-of-marital-intimacy", state: "local", group: "audio", kind: "Audio", title: "Modernising the Psychology of Intimacy", summary: "Critical audio on where the session dates. Read against the module caution.", href: "../assets/media/tmc-father/m06/audio/modernizing-the-psychology-of-marital-intimacy.mp3", mediaType: "audio" },
    { slug: "slides-the-intimacy-blueprint", state: "local", group: "slides", kind: "PDF", title: "The Intimacy Blueprint", summary: "Session overview deck.", href: "../assets/media/tmc-father/m06/slides/the-intimacy-blueprint.pdf", linkLabel: "Open slide deck" },
    { slug: "slides-the-intimacy-blueprint-2", state: "local", group: "slides", kind: "PDF", title: "The Intimacy Blueprint (Part Two)", summary: "Second half of the blueprint deck.", href: "../assets/media/tmc-father/m06/slides/the-intimacy-blueprint-2.pdf", linkLabel: "Open slide deck" },
    { slug: "slides-relational-circuitry", state: "local", group: "slides", kind: "PDF", title: "Relational Circuitry", summary: "How connection, safety, and desire wire together.", href: "../assets/media/tmc-father/m06/slides/relational-circuitry.pdf", linkLabel: "Open slide deck" },
    { slug: "infographic-the-spark-and-the-flame", state: "local", group: "infographics", title: "The Spark and the Flame", summary: "Friendship, attention, and desire over a long marriage.", href: "../assets/media/tmc-father/m06/infographics/the-spark-and-the-flame.png", alt: "Illustrated field guide titled The Spark and the Flame: A Field Guide to Sexual Intimacy in Marriage, using a mower spark plug as its central image, with five secrets, a reality-check section on the young-children season, a red panel of warning signs including pornography and emotional adultery, and a three-step action checklist." },
    { slug: "infographic-keeping-the-spark-alive", state: "local", group: "infographics", title: "Keeping the Spark Alive", summary: "Habits that protect intimacy in an ordinary week.", href: "../assets/media/tmc-father/m06/infographics/keeping-the-spark-alive.png", alt: "Illustrated field guide titled Keeping the Spark Alive: The Heart of Intimacy, with five points on emotional connection, guarding the bedroom as screen-free space, desire following a decision, kindness as the foundation of safety, and consent being voluntary and revocable." },
    { slug: "infographic-five-secrets-of-sexual-intimacy", state: "local", group: "infographics", title: "Five Secrets of Sexual Intimacy", summary: "Five practices, with a consent and safety panel.", href: "../assets/media/tmc-father/m06/infographics/five-secrets-of-sexual-intimacy.png", alt: "Illustrated field guide titled Keeping the Spark Alive: The 5 Secrets of Sexual Intimacy, with five numbered points on speaking openly, protecting time and space, building anticipation, responding with trust, and other-centred kindness, closing with a note to seek help where there is fear, control, addiction, or abuse." },
    { slug: "report-briefing-document-the-marriage-course-episode-6-sexual-intimacy", state: "local", group: "reports", title: "Sexual Intimacy: Session Briefing", summary: "Executive briefing — best starting point for this module.", href: "../assets/media/tmc-father/m06/reports/briefing-document-the-marriage-course-episode-6-sexual-intimacy.pdf", linkLabel: "Read the report" },
    { slug: "report-beyond-the-bedroom-reclaiming-the-spark-in-your-marriage", state: "local", group: "reports", title: "Beyond the Bedroom", summary: "Longer treatment of intimacy as friendship, safety, and attention.", href: "../assets/media/tmc-father/m06/reports/beyond-the-bedroom-reclaiming-the-spark-in-your-marriage.pdf", linkLabel: "Read the report" },
    { slug: "report-good-luck-mr-gorsky-5-surprising-truths-about-keeping-the-spark-alive", state: "local", group: "reports", title: "Five Surprising Truths About Keeping the Spark Alive", summary: "Popular-article register — use as a prompt, not as proof.", href: "../assets/media/tmc-father/m06/reports/good-luck-mr-gorsky-5-surprising-truths-about-keeping-the-spark-alive.pdf", linkLabel: "Read the report" },
    { slug: "quiz-marriage-quiz", state: "local", group: "quiz", title: "Marriage Quiz", summary: "Knowledge check over this module.", href: "../assets/media/tmc-father/m06/quiz/marriage-quiz.html", linkLabel: "Open the quiz" },
    { slug: "flashcards-marriage-flashcards", state: "local", group: "flashcards", title: "Marriage Flashcards", summary: "Flashcard drill over this module.", href: "../assets/media/tmc-father/m06/flashcards/marriage-flashcards.html", linkLabel: "Open the flashcards" }
  ]
};
