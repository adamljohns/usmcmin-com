/* The Father Course — installable, offline-capable service worker.
 *
 ...
 *   - Lives at /tmc-father/sw.js so its default scope is /tmc-father/ —
 *     it never fights the civic root worker; longest-scope-match wins here.
 *
 * Course progress lives in localStorage (usmcmin:tmc-father:v1:*). This worker
...
const OFFLINE_FALLBACK = '/tmc-father/index.html';

const CORE_ASSETS = [
  '/tmc-father/index.html',
  '/tmc-father/about.html',
  '/tmc-father/progress.html',
  '/tmc-father/module-01.html',
  '/tmc-father/module-02.html',
  '/tmc-father/module-03.html',
  '/tmc-father/module-04.html',
  '/tmc-father/module-05.html',
  '/tmc-father/module-06.html',
  '/tmc-father/module-07.html',
  '/assets/css/main.css',
  '/assets/css/tmc-father.v2.css',
  '/assets/js/main.js',
  '/assets/js/tmc-father.v1.js',
