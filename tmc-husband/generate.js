...
function siteNav() {
  return `<nav>
    ...
    <ul class="nav-links">
      ...
      <li><a href="/tmc-husband/index.html" class="active">The Husband Course</a></li>
...
function rankBanner() {
  return `<section class="rank-banner" aria-labelledby="rank-title">
    ...
    <div class="rank-copy">
      ...
      <h2 id="rank-title" data-rank>Still in the Rack</h2>
      <p class="rank-milestone" data-milestone aria-live="polite">Still in the rack. Begin Module 1 when you are ready.</p>
    </div>
  </section>`;
}
