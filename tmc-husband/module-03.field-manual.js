...
const fieldManual = {
  ...
  resources: {
    ...
    intro: 'Eleven NotebookLM artifacts from Episode 3 are embedded below. Three audio briefings and three video overviews are linked via the NotebookLM notebook until exported. Treat generated media as study aids — read against the caution section above.',
    groups: [
