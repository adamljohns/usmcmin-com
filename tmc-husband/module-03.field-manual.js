...
const fieldManual = {
  ...
  artifacts: [
    ...
    { slug: 'infographic-conflict-resolution-field-guide', state: 'local', group: 'infographics', title: 'Marriage Conflict Resolution Field Guide', summary: 'Navigating the Waves Together — includes red-flag panel.', href: '../assets/media/tmc-husband/m03/infographics/marriage-conflict-resolution-field-guide.png', alt: 'Illustrated field guide titled Navigating the Waves Together with panels on teamwork, appreciation, and the five-step protocol.' },
    { slug: 'infographic-conflict-and-teamwork-guide', state: 'local', group: 'infographics', title: 'Marriage Conflict and Teamwork Guide', summary: 'Navigating the Storm — includes safety overlay.', href: '../assets/media/tmc-husband/m03/infographics/marriage-conflict-and-teamwork-guide.png', alt: 'Illustrated guide titled Navigating the Storm with conflict toolkit and seven-day action plan.' },
    { slug: 'infographic-teamwork-guide', state: 'local', group: 'infographics', title: 'Marriage Teamwork Guide', summary: 'Five cards on appreciation, differences, timing, and support.', href: '../assets/media/tmc-husband/m03/infographics/marriage-teamwork-guide.png', alt: 'Illustrated guide titled From Conflict to Connection showing five teamwork cards.' },
    { slug: 'report-conflict-resolution-and-partnership', state: 'local', group: 'reports', title: 'Conflict Resolution and Partnership', summary: 'Executive briefing — best starting point.', href: '../assets/media/tmc-husband/m03/reports/conflict-resolution-and-partnership-briefing.md', linkLabel: 'Read the report' },
    { slug: 'report-from-clashing-oars-to-gliding-boats', state: 'local', group: 'reports', title: 'From Clashing Oars to Gliding Boats', summary: 'Systems-flavoured treatment of the rowing metaphor.', href: '../assets/media/tmc-husband/m03/reports/from-clashing-oars-to-gliding-boats.md', linkLabel: 'Read the report' },
    { slug: 'report-biggest-disagreements-secret-weapon', state: 'local', group: 'reports', title: 'Why Your Biggest Disagreements Might Be Your Secret Weapon', summary: 'Popular-article register — headline overclaims; read against caution.', href: '../assets/media/tmc-husband/m03/reports/why-your-biggest-disagreements-secret-weapon.md', linkLabel: 'Read the report' },
    { slug: 'quiz-marriage-quiz', state: 'local', group: 'quiz', title: 'Marriage Quiz', summary: 'Knowledge check.', href: '../assets/media/tmc-husband/m03/quiz/marriage-quiz.html', linkLabel: 'Open the quiz' },
    { slug: 'flashcards-marriage-flashcards', state: 'local', group: 'flashcards', title: 'Marriage Flashcards', summary: 'Flashcard drill.', href: '../assets/media/tmc-husband/m03/flashcards/marriage-flashcards.html', linkLabel: 'Open the flashcards' },
    { slug: 'audio-when-good-marriage-advice-goes-wrong', state: 'withheld', group: 'withheld', kind: 'Audio', title: 'When Good Marriage Advice Goes Wrong', summary: 'Critical audio on where conflict advice misfires.' },
    { slug: 'audio-when-marriage-tools-become-dangerous-weapons', state: 'withheld', group: 'withheld', kind: 'Audio', title: 'When Marriage Tools Become Dangerous Weapons', summary: 'Safety inversion discussion.' },
    { slug: 'audio-why-your-partner-is-not-the-problem', state: 'withheld', group: 'withheld', kind: 'Audio', title: 'Why your partner is not the problem', summary: 'Externalising the issue — read with caution attached.' },
    { slug: 'video-how-to-externalize-marriage-conflict', state: 'withheld', group: 'withheld', kind: 'Video', title: 'How to Externalize Marriage Conflict', summary: 'Video on the sofa image.' },
    { slug: 'video-navigating-conflict', state: 'withheld', group: 'withheld', kind: 'Video', title: 'Navigating Conflict', summary: 'Video overview.' },
    { slug: 'video-resolving-conflict', state: 'withheld', group: 'withheld', kind: 'Video', title: 'Resolving Conflict', summary: 'Video on four principles and five steps.' }
  ]
};
