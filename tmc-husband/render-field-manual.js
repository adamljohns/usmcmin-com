...
function renderFieldManual({ module, course, layout, progressPanel, esc, prev, next }) {
  ...
  const insertLink = `<aside class="module-print" aria-labelledby="print-${module.number}-title">
      ...
      <p class="module-print-alt">Taking the whole course on paper? <a href="/downloads/tmc-husband/The_Husband_Course_WORKBOOK.pdf">The Husband Course Workbook</a> carries all seven modules.</p>
    </aside>`;
